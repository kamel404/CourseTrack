...
class PostListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final posts = isHomeView ? postProvider.posts.take(3).toList() : postProvider.posts;
    
    // Debug print to see what's happening with the posts
    print('PostListScreen build - Post count: ${posts.length}');
    if (posts.isNotEmpty) {
      print('First post title: ${posts.first.title}');
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        try {
          ...
          print('Error rendering post card for post at index $i: $e');
          return Card(
